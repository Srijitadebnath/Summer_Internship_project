  ...
  return (
    ...
    >
      <div>
        ...
        {/* Technical specifications (Hidden if empty as requested) */}
...
export const BathroomCatalogueView: React.FC<BathroomCatalogueViewProps> = ({ onBack }) => {
  ...
  const brandsList = ['All', 'PARRYWARE', 'BATHSENSE'];
  ...
  const filteredProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      const matchBrand = selectedBrand === 'All' || product.brand.includes(selectedBrand);
    ...
    <div className="w-full bg-white py-6 md:py-12 px-4 sm:px-6 md:px-12 lg:px-20 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <CatalogueVideoBanner
          ...
          subtitle="Explore our premium bathroom and wellness solutions. Authorized distributors of Parryware and Bathsense (Asian Paints), delivering world-class faucets, overhead rain showers, diverters, and health sprays."
